...
class OpenAIProvider(BaseProvider):
    ...
    def build_poll_request_spec(
        ...
        *,
        ...
        """
        Build OpenAI poll request metadata.
        """
    ...
    async def parse_poll_response(
        ...
        *,
        ...
        """
        Parse OpenAI poll payload into normalized snapshot.
        """
    ...
    def build_results_request_spec(
        ...
        *,
        ...
        """
        Build OpenAI results request metadata.
        """
    ...
    def decode_results_content(
        ...
        *,
        ...
        """
        Decode OpenAI JSONL results into responses keyed by custom ID.
        """
    ...
    def build_resume_context(
        ...
        *,
        ...
        """
        Build OpenAI resumed-polling context.
        """
